...
```{r, echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1Covg_bpPYGKnTVbOjX_FkGgWHBG6VwdEySKbpZNwqKo/edit#slide=id.g3710e1bbefd_0_34")
```

Check your email and click on the verification link.  This will log you into SciServer.

```{r, echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1Covg_bpPYGKnTVbOjX_FkGgWHBG6VwdEySKbpZNwqKo/edit#slide=id.g3710e1bbefd_0_42")
```

Confirm that your username appears in the upper right hand corner.

```{r, echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1Covg_bpPYGKnTVbOjX_FkGgWHBG6VwdEySKbpZNwqKo/edit#slide=id.g3710e1bbefd_0_48")
```
...
```{r, echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1Covg_bpPYGKnTVbOjX_FkGgWHBG6VwdEySKbpZNwqKo/edit#slide=id.g3710e1bbefd_0_25")
```
...
```{r, echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1Covg_bpPYGKnTVbOjX_FkGgWHBG6VwdEySKbpZNwqKo/edit#slide=id.g3710e1bbefd_0_59")
```

Voila!  You should now see the Jupyter interface.

```{r, echo = FALSE}
ottrpal::include_slide("https://docs.google.com/presentation/d/1Covg_bpPYGKnTVbOjX_FkGgWHBG6VwdEySKbpZNwqKo/edit#slide=id.g3710e1bbefd_0_64")
```
...
## Start replicating the `head` command in Python

We can replicate the `head` command by implementing a `for` loop to read the file line by line as we introduced in Ch 6. Parsing text files.

`for` loops are great for iterating through items in a collection, like lines in a file. We can use a counter to limit how many lines we print.
...
## Let's put it all together, building the `head` command in Python step by step
