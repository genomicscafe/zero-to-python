...
This exercise shpuld be don in the Jupyter terminal.
...
Starting with a `for` loop is great for iterating through items in a collection, like lines in a file. We can add a counter variable and a conditionsl `if` statement to limit how many lines we print.
