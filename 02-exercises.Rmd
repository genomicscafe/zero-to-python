...
Congratulations! You've sucessfully completed all the exercises and practiced creating multiple Python scripts and running them at tge UNIX command line.
...
As you continue your journey with Python, try replicating these two additionall UNIX commands that are commonly used to filter and subset text files:
